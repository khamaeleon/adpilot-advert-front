...
import {findRevisionTargetingBudgetDetail} from "../../services/Platform/HistoryAxios";

const targetBudgetHistory = [
  {groupName: '이벤트 예산 그룹명'},
...
export function HistoryTargetingDetail () {
      ...
      <BoardTap>
        <BoardTableContainer>
          <table>
            ...
            {targetBudgetHistory.map((entry, key) => {
              return(
                <tr key={key}>
