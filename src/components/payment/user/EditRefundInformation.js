...
export function EditRefundInformationButton(props) {
        ...
        setModal({
            ...
            modalComponent: () => {
                return (
                    ...
                    <SearchModal onSave={onSave} modalInfo={modalInfo} onSubmit={onSubmit}/>
                )
            }
        })
    }
    return <Edit onClick={handleModalComponent}>{title}</Edit>
}
